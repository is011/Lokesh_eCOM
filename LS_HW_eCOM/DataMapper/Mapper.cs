...
using LS_HW_eCOM.ViewModels.Category;
using LS_HW_eCOM.ViewModels.Food;
using LS_HW_eCOM.ViewModels.Home;
using LS_HW_eCOM.ViewModels.Order;
using LS_HW_eCOM.ViewModels.OrderDetail;
using System;
using System.Collections.Generic;
using System.Linq;
using System.Threading.Tasks;

namespace LS_HW_eCOM.DataMapper
{
    public class Mapper
    {
